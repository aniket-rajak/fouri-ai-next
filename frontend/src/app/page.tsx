...
const StudentBenefits = dynamic(() => import("@/components/landing/StudentBenefits"), { ssr: true });
const AIDashboardShowcase = dynamic(() => import("@/components/landing/AIDashboardShowcase"), { ssr: true });
...
const FreeAccess = dynamic(() => import("@/components/landing/FreeAccess"), { ssr: true });
...
export default function Home() {
  return (
    <main>
      ...
      <HeroSection />
      <HowItWorks />
      <AdSlot slot="landing-in-content" format="horizontal" className="mx-auto max-w-[728px] my-8 px-4 sm:px-6 lg:px-8" />
      <FeaturesSection />
      <StudentBenefits />
      <AIDashboardShowcase />
      <AboutSection />
